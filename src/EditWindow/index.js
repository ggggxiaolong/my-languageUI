                        ...
                        {contentnew.map(item =>
                            <div key={item.id} className='contentlanguage'>
                                {languagetype_old.includes('en')
                                    ?
                                    <p>
                                        <span><b>en: </b>{item.en === null ? 'No content' : item.en}</span>&nbsp;&nbsp;
                                        <button
                                ...
                                {languagetype_old.includes('es') ? <p>
                                    <span><b>es: </b>{item.es === null ? 'No content' : item.es}</span>&nbsp;&nbsp;
                                    <button
                                        className='modify_button'
                                ...
                                {languagetype_old.includes('ko') ? <p>
                                    <span><b>ko: </b>{item.ko === null ? 'No content' : item.ko}</span>&nbsp;&nbsp;
                                    <button
                                        className='modify_button'
                                ...
                                {languagetype_old.includes('ja') ? <p>
                                    <span><b>ja: </b>{item.ja === null ? 'No content' : item.ja}</span>&nbsp;&nbsp;
                                    <button
                                        className='modify_button'
                                ...
                                {languagetype_old.includes('sk') ? <p>
                                    <span><b>sk: </b>{item.sk === null ? 'No content' : item.sk}</span>&nbsp;&nbsp;
                                    <button
                                        className='modify_button'
                                ...
                                {languagetype_old.includes('cs') ? <p>
                                    <span><b>cs: </b>{item.cs === null ? 'No content' : item.cs}</span>&nbsp;&nbsp;
                                    <button
                                        className='modify_button'
                                ...
                                {languagetype_old.includes('fr') ? <p>
                                    <span><b>fr: </b>{item.fr === null ? 'No content' : item.fr}</span>&nbsp;&nbsp;
                                    <button
                                        className='modify_button'
